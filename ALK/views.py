...
def upload_file_view(request):
    return render(request, 'alk.html')

# Molecular descriptor calculator
def desc_calc():
    # Performs the descriptor calculation
    bashCommand = "java -Xms2G -Xmx2G -Djava.awt.headless=true -jar /Users/apoorvav/bioactivityApp/ALK/data/PaDEL-Descriptor/PaDEL-Descriptor.jar -removesalt -standardizenitro -fingerprints -descriptortypes /Users/apoorvav/bioactivityApp/ALK/data/PaDEL-Descriptor/PubchemFingerprinter.xml -dir ./ -file descriptors_output.csv"
...
def build_model(input_data, load_data):
    ...
    load_model = pickle.load(open('/Users/apoorvav/bioactivityApp/ALK/data/ALK_model.pkl', 'rb'))
...
def index(request):
    ...
    if request.method == 'POST':
        ...
        if uploaded_file is None:  # No file uploaded
            ...
            return render(request, 'alk.html', {'error': error_message})
        ...
        Xlist = list(pd.read_csv('/Users/apoorvav/bioactivityApp/ALK/data/descriptor_list .csv').columns)
